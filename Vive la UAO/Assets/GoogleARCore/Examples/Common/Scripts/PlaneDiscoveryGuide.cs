                ...
                Session.LostTrackingReason != LostTrackingReason.None)
            {
                ...
                switch (Session.LostTrackingReason)
                {
                    ...
                    case LostTrackingReason.InsufficientFeatures:
                        m_SnackBarText.text = "Apunta el dispositivo a una superficie con más textura o color.";
                        break;
                    case LostTrackingReason.ExcessiveMotion:
                        m_SnackBarText.text = "Te mueves demasiado rápido. Ve más despacio.";
                        break;
                    default:
                        m_SnackBarText.text = "El seguimiento de movimiento se pierde.";
                        break;
                }
